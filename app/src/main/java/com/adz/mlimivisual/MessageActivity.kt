...
import com.adz.mlimivisual.Services.SendMediaService
import com.adz.mlimivisual.databinding.ActivityMessageBinding
import com.adz.mlimivisual.databinding.LeftItemLayoutBinding
import com.adz.mlimivisual.databinding.RightItemLayoutBinding
import com.adz.mlimivisual.models.ChatListModel
...
class MessageActivity : AppCompatActivity() {
    ...
    private fun pickImage() {
        ...
        val options: Options = Options.init()
            ...
            .setPath("/Mlimi Visuals/Media/Sent")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == 100) {
            ...
            if (chatId == null) {
                ...
                returnValue?.forEach { path ->
                    // Check if the media item is an image or a video
