package com.adz.mlimivisual.data
...
data class TextMessage(val text: String?=null)

data class AudioMessage(var uri: String?=null,val duration: Int=0)

data class ImageMessage(var uri: String?=null,var imageType: String="image")

data class VideoMessage(val uri: String?=null,val duration: Int=0)

data class FileMessage(val name: String?=null, val uri: String?=null,val duration: Int=0)
